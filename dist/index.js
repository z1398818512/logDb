...
/* harmony export */ });
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(118);
...
class serve {
  constructor(props = {}) {
     // 单例模式
     if (serveInstrance) {
      console.info('已启动在线日志预览页：' + onlineUrl)
  ...
  async queryData(data = {}) {
    ...
    var FilterDateLogger = (0,_model__WEBPACK_IMPORTED_MODULE_0__/* .getFilterDateLogger */ .z)(this.db.logger, start, end).reverse()
...
class logDb extends Dexie$1 {
    constructor(props = {}) {
        ...
        const { databaseName = 'log', expirationTime, isEmit,serveUrl } = props;
        ...
        this.serveUrl = serveUrl || 'http://127.0.0.1:7001/user',
